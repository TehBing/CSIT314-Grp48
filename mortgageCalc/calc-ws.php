 ...
 * Calculates the Breakdown schedule and returns the results.
 *
**/
...
// Settings
define(\'LAYOUT\', \'' . $layout . '\'); // breakdown schedule modal, div or popup
...
define(\'DISCLAIMER\', \'' . $disclaimer . '\');';
        ...
        ////////////////////////////////////
        // PMI and Taxes
        $jsonData['blurb'] .=  'We will only consider Principal and Interest'
        ...
        $jsonData['blurb'] .=  "According to HDB rules, your downpayment must be 20%. ";

        if ($down < 20) {
            $jsonData['blurb'] .=  'Your down payment was less than 20% of the loan. '
                .' This is not allowed. Please think about how much downpayment you want to put. ';
            ...
            $jsonData['blurb'] .=  'Since you are putting down 20% or greater, you will not have to'
                .' pay PMI.  So, your monthly payment with taxes'
